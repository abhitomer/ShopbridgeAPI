...
using ShopBridgeBusinessServices;
using ShopBridgeBusinessServices.AutoMapper;
...
namespace ShopBridgeTests
{
    public class Tests : BaseSpecs
    {
        ...
        public async Task Can_get_item()
        {
            ...
            var returned = (ProductEntity)result;
        ...
        public async Task Can_get_all_items()
        {
            ...
            var fetchItemsOutputData = (List<ProductEntity>)fetchItemsData;
        ...
        private async Task<IActionResult> CreateItem(ProductEntity item)
        {
        ...
        private async Task<IActionResult> UpdateItem(int id, ProductEntity item)
        {
        ...
        private ProductEntity Item(Action<ProductEntity> action = null)
        {
        ...
        private static void AssertItem(ProductEntity expectedItem, ProductEntity actualItem)
        {
